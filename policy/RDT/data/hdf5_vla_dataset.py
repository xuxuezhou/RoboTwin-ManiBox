    ...
    def parse_hdf5_file(self, file_path):
        ...
        with h5py.File(file_path, 'r') as f:
            ...
            def fill_in_state(values):
                ...
                UNI_STATE_INDICES = [
                    STATE_VEC_IDX_MAPPING[f"left_arm_joint_{i}_pos"] for i in range(left_arm_dim[0])
                ] + [
                    STATE_VEC_IDX_MAPPING["left_gripper_open"]
                ] + [
                    STATE_VEC_IDX_MAPPING[f"right_arm_joint_{i}_pos"] for i in range(right_arm_dim[0])
                ] + [
