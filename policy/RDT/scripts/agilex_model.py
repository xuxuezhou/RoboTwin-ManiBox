...
def create_model(args, **kwargs):
    ...
    AGILEX_STATE_INDICES = [
        ...
        STATE_VEC_IDX_MAPPING[f"right_arm_joint_{i}_pos"] for i in range(right_arm_dim)
    ] + [
        STATE_VEC_IDX_MAPPING[f"right_gripper_open"]
    ]
...
class RoboticDiffusionTransformerModel(object):
    ...
    def __init__(
        ...
        self.left_arm_dim, self.right_arm_dim = args['arm_dim']['left_arm_dim'], args['arm_dim']['right_arm_dim']
