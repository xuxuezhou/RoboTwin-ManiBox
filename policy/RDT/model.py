...
class RDT:
    def __init__(self, pretrained_model_name_or_path, task_name, left_arm_dim, right_arm_dim, rdt_step):
        # set path
        current_file = Path(__file__)
    ...
    def make_policy(self,args):
        ...
        args["config"]['arm_dim'] = {'left_arm_dim': self.left_arm_dim, 'right_arm_dim': self.right_arm_dim}
